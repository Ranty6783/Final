...
function drawPlayer(){
  ...
  if(playerState==="idle"){
    ...
    image(sheet,px-sheet.width,py-sheet.height, 
      sx(sheet.width*2),sy(sheet.height*2)); 
  }else{
